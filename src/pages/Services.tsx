  ...
  return (
    <div className="bg-white">
      ...
      <SectionReveal className="py-20 lg:py-28 relative">
        <div className="absolute right-0 top-40 w-1/3 h-64 bg-[#4A908F]/5 transform -skew-y-6"></div>
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          ...
          <FadeIn className="flex flex-col lg:flex-row bg-white modern-card relative overflow-hidden rounded-3xl overflow-hidden shadow-sm border border-gray-100 mb-10 group hover:shadow-md transition-shadow">
            ...
            <div className="w-full lg:w-1/2 p-10 lg:p-16 flex flex-col justify-center">
              <div className="w-14 h-14 rounded-2xl bg-[#4A908F]/10 text-[#4A908F] flex items-center justify-center mb-6">
                <Ear size={28} />
              </div>
              ...
              <ul className="space-y-3 mb-8 text-gray-600 font-medium">
                <li className="flex items-center gap-3"><span className="w-1.5 h-1.5 rounded-full bg-[#4A908F]"></span> Pure Tone Audiometry</li>
                <li className="flex items-center gap-3"><span className="w-1.5 h-1.5 rounded-full bg-[#4A908F]"></span> OAE (Newborn Screening)</li>
                <li className="flex items-center gap-3"><span className="w-1.5 h-1.5 rounded-full bg-[#4A908F]"></span> Digital Hearing Aids Fitting</li>
              </ul>
          ...
          <StaggerContainer className="flex flex-col lg:flex-row gap-8 mb-10">
            <StaggerItem className="w-full lg:w-1/2 bg-gray-50 rounded-3xl p-10 lg:p-12 hover:shadow-md hover:-translate-y-1 transition-all group relative overflow-hidden">
              ...
              <div className="relative z-10 h-full flex flex-col">
                <div className="w-12 h-12 rounded-xl bg-white text-[#4A908F] flex items-center justify-center mb-6 shadow-sm border border-gray-100">
                  <Mic2 size={24} />
                </div>
                ...
                <Link to="/contact" className="inline-flex items-center gap-2 text-[#4A908F] font-semibold group-hover:gap-3 transition-all mt-auto">
          ...
          <div>
            ...
            <StaggerContainer className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              {/* Large Block */}
              <StaggerItem className="md:col-span-2 bg-[#4A908F] text-white rounded-3xl p-10 relative overflow-hidden group">
                ...
                <div className="relative z-10">
                  ...
                  <Link to="/programs" className="inline-flex items-center justify-center px-6 py-3 bg-white text-[#4A908F] rounded-full font-semibold hover:bg-gray-50 hover:scale-[1.02] transition-all">
                    Explore Programs
                  </Link>
                </div>
              </StaggerItem>
