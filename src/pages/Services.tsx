    ...
    <div className="bg-white">
      ...
      <SectionReveal className="py-20 lg:py-28 relative">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          ...
          <FadeIn className="flex flex-col lg:flex-row bg-white modern-card relative overflow-hidden rounded-[32px] overflow-hidden shadow-sm border border-gray-100 mb-10 group hover:shadow-md transition-shadow">
          ...
          <StaggerContainer className="flex flex-col lg:flex-row gap-8 mb-10">
            <StaggerItem className="w-full lg:w-1/2 bg-gray-50 rounded-[32px] p-10 lg:p-12 hover:shadow-md hover:-translate-y-1 transition-all group relative overflow-hidden">
            ...
            <StaggerItem className="w-full lg:w-1/2 bg-white modern-card relative overflow-hidden rounded-[32px] p-10 lg:p-12 border-2 border-primary/10 hover:border-primary/30 hover:shadow-md hover:-translate-y-1 transition-all group relative overflow-hidden">
               <div className="absolute inset-0 opacity-10 pointer-events-none group-hover:opacity-20 transition-opacity">
      ...
      <SectionReveal className="py-20 lg:py-28 bg-gray-50 border-t border-gray-100">
        <div className="container mx-auto px-6 lg:px-8">
          ...
          <StaggerContainer className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            {/* Large Block */}
            <StaggerItem className="md:col-span-2 bg-primary text-white rounded-[32px] p-10 relative overflow-hidden group">
            ...
            <div className="md:col-span-1 flex flex-col gap-6">
              <StaggerItem className="bg-white modern-card relative overflow-hidden rounded-[32px] p-8 shadow-sm border border-gray-100 hover:shadow-md hover:-translate-y-1 transition-all flex-grow flex flex-col group">
