...
const Services = () => {
  return (
    <div className="bg-white">
      ...
      <SectionReveal className="py-16 lg:py-24 relative">
        ...
        <div className="container mx-auto px-6 lg:px-8 relative z-10">
          ...
          <FadeIn className="flex flex-col lg:flex-row bg-white modern-card card-hover-glow relative overflow-hidden rounded-[32px] overflow-hidden shadow-sm border border-gray-100 mb-10 group">
            ...
            <div className="w-full lg:w-1/2 p-10 lg:p-16 flex flex-col justify-center">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Hearing Testing & Audiology</h2>
          ...
          <StaggerContainer className="flex flex-col lg:flex-row gap-8 mb-10">
            <StaggerItem className="w-full lg:w-1/2 bg-gray-50 rounded-[32px] p-10 lg:p-12 card-hover-border group relative overflow-hidden">
              ...
              <div className="relative z-10 h-full flex flex-col">
                <div className="w-12 h-12 rounded-2xl bg-white text-primary flex items-center justify-center mb-6 shadow-sm border border-gray-100">
                  <Mic2 size={24} />
                </div>
            ...
            <StaggerItem className="w-full lg:w-1/2 bg-white modern-card card-hover-glow relative overflow-hidden rounded-[32px] p-10 lg:p-12 border-2 border-primary/10 group relative overflow-hidden">
               <div className="absolute inset-0 opacity-10 pointer-events-none group-hover:opacity-20 transition-opacity">
      ...
      <SectionReveal className="py-16 lg:py-24 bg-gray-50 border-t border-gray-100">
        <div className="container mx-auto px-6 lg:px-8">
          <FadeIn className="flex items-center gap-4 mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-800">Child Development Programs</h2>
          ...
          <StaggerContainer className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            {/* Large Block */}
            <StaggerItem className="md:col-span-2 bg-primary text-white rounded-[32px] p-10 relative overflow-hidden group card-hover-lift">
            ...
            <div className="md:col-span-1 flex flex-col gap-6">
              <StaggerItem className="bg-white modern-card card-hover-border relative overflow-hidden rounded-[32px] p-8 shadow-sm border border-gray-100 flex-grow flex flex-col group">
              ...
              <StaggerItem className="bg-white modern-card card-hover-glow relative overflow-hidden rounded-[32px] p-8 shadow-sm border border-gray-100 flex-grow flex flex-col group">
                 <div className="flex items-center gap-3 mb-3">
