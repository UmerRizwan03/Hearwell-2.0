...
const PageHeader: React.FC<PageHeaderProps> = ({ title, subtitle, image }) => {
  return (
    <div className="relative isolate bg-[#1D544F]/[0.02] overflow-hidden py-16 md:py-24 border-b border-[#1D544F]/5">
      ...
      <div className="absolute top-0 right-0 w-64 h-64 bg-[#1D544F]/[0.06] rounded-full blur-3xl -translate-y-1/2 translate-x-1/3 -z-10"></div>
      <div className="absolute bottom-0 left-0 w-80 h-80 bg-[#82CFB0]/[0.08] rounded-full blur-3xl translate-y-1/3 -translate-x-1/2 -z-10"></div>
      
      {/* Abstract Soundwave Graphic */}
      <svg className="absolute top-[40%] left-0 w-[150%] h-[120%] -translate-y-1/2 opacity-[0.03] text-[#1D544F] min-w-[1200px] -z-10 pointer-events-none" viewBox="0 0 1200 200" preserveAspectRatio="none">
